...
document.addEventListener('DOMContentLoaded',async ()=>{
  ...
  try {
    ...
    const mostrar= await axios.get('/api/secadoras/reservasID')
    console.log(mostrar);
    ...
    <div class="bg-white shadow-md rounded-md mx-10 p-4 flex flex-col ">
    <h2 class="text-lg text-center font-bold mb-2">Secadora ${element.secadora}</h2>
